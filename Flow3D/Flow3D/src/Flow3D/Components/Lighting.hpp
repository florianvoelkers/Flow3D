...
public: 
	...
	inline void SetAmbientIntensity(Vec3 ambient) { m_Ambient = ambient; }
	inline void SetDiffuseIntensity(Vec3 diffuse) { m_Diffuse = diffuse; }
	inline void SetSpecularIntensity(Vec3 specular) { m_Specular = specular; }
...
public:
	...
	inline Attenuation& GetAttenuation() { return m_Attenuation; }
	inline const Vec3 GetDirection() const { return GetTransform().GetForwardVector(); }
